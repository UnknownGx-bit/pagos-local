...
export function SettingsView({ accounts, settings, onImportExcel, afterMutation }: SettingsViewProps) {
  ...
  return (
    <main>
      ...
      <section className="settings-section about-card"><Info /><div><h2>Pagos Local 1.3.2</h2><p>Los datos viven en IndexedDB y no se envían a ningún servidor. La PWA funciona sin conexión; las notificaciones programadas con la app cerrada están disponibles en Android.</p></div></section>
